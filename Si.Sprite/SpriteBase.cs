...
namespace Si.GameEngine.Sprites._Superclass
{
    ...
    public class SpriteBase
    {
        ...
        /// </summary>
        /// <=>s></returns>
        public double DeltaAngleDegrees(SiVector toLocation) => SiSpriteVectorMath.DeltaAngle(this, toLocation);
        ...
        public double AngleTo360(SiVector location) => SiSpriteVectorMath.AngleTo360(this, location);

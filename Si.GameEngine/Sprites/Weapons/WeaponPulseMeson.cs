...
namespace Si.GameEngine.Sprites.Weapons
{
    internal class WeaponPulseMeson : WeaponBase
    {
        ...
        public WeaponPulseMeson(GameEngineCore gameEngine, SpriteShipBase owner)
            : base(gameEngine, owner, Name, soundPath, soundVolumne) => InitializeWeapon();

        public WeaponPulseMeson(GameEngineCore gameEngine)
        ...
        {
            return new MunitionPulseMeson(_gameEngine, this, _owner, xyOffset);
        }

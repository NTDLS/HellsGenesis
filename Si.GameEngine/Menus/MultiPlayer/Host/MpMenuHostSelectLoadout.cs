...
namespace Si.Menus.SinglePlayer
{
    ...
    /// </summary>
    internal class MpMenuHostSelectLoadout : MenuBase
    {
        private readonly SpriteMenuItem _shipBlurb;
        private Timer _animationTimer;
        private SpritePlayerBase _selectedSprite;

        public MpMenuHostSelectLoadout(GameEngine.GameEngineCore gameEngine)
            : base(gameEngine)
        {
        ...
        {
            _gameEngine.Menus.Show(new MpMenuHostSituationSelect(_gameEngine));
            return true;
        }
        ...
        private bool PlayerLoadoutMenu_OnExecuteSelection(SpriteMenuItem item)
        {
            ...
            _gameEngine.Menus.Show(new MpMenuHostLobbyWait(_gameEngine));
            return true;
        }

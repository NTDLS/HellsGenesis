...
namespace NebulaSiege.Game.Engine.Types.Geometry
{
    internal class NsAngle
    {
        ...
        public static NsPoint ToXY(NsAngle angle)
        {
        ...
        public NsAngle(NsAngle angle)
        {
            Degrees = angle.Degrees;
        }

        public NsAngle(double degrees)
        {
            Degrees = degrees;
        }

        public NsAngle(double x, double y)
        {
        ...
        public static NsAngle operator -(NsAngle original, NsAngle modifier)
        {
            return new NsAngle(original.Degrees - modifier.Degrees);
        }

        public static NsAngle operator -(NsAngle original, double degrees)
        {
            return new NsAngle(original.Degrees - degrees);
        }
        ...
        {
            return Math.Round(((NsAngle)o).X, 4) == X && Math.Round(((NsAngle)o).Y, 4) == Y;
        }

...
namespace NebulaSiege.Game.Engine.Types
{
    ...
    /// </summary>
    internal class NsEngineCallbackEvent
    {
        ...
        public delegate void HgOnExecute(EngineCore core, NsEngineCallbackEvent sender, object refObj);
        ...
        public NsEngineCallbackEvent(EngineCore core, TimeSpan countdown, HgOnExecute executeCallback, object refObj,
        ...
        public NsEngineCallbackEvent(EngineCore core, TimeSpan countdown, HgOnExecute executeCallback)
        {
            _core = core;
            _countdown = countdown;
            _onExecute = executeCallback;

using NebulaSiege.Server.Engine;
using NebulaSiege.Shared;
using Topshelf;

namespace NebulaSiege.Server.Service
{
    public class Program
    {
        ...
        private static NebulaSiegeSettings? _settings = null;
        public static NebulaSiegeSettings Configuration
        {
            get
            {
                if (_settings == null)
                {
                    ...
                    _settings = config.GetRequiredSection("Settings").Get<NebulaSiegeSettings>();
                    if (_settings == null)
                    {
        ...
        public static void Main()
        {
            HostFactory.Run(x =>
            {
                ...
                x.SetDescription("NebulaSiege game server service.");
                x.SetDisplayName("NebulaSiege Service");
                x.SetServiceName("NebulaSiege");
            });
        }
    }
}

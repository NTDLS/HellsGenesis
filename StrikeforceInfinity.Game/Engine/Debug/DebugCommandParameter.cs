...
using static StrikeforceInfinity.Game.Engine.Debug.DebugCommandParameterPrototype;

namespace StrikeforceInfinity.Game.Engine.Debug
{
    internal class DebugCommandParameter
    {

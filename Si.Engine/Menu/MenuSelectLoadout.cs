    ...
    internal class MenuSelectLoadout : MenuBase
    {
            ...
            : base(engine)
        {
            ...
            foreach (var playerType in playerTypes)
            {
                ...
                playerSprite.Velocity.ForwardAngle.Degrees = 45;

                offsetY += playerSprite.Size.Height / 2.0f + previousSpriteSize / 2.0f + 25;
                previousSpriteSize = playerSprite.Size.Height;

                var menuItem = AddSelectableItem(new SiPoint(offsetX + 75, offsetY), playerSprite.Loadout.Name, playerSprite.Loadout.Name);
            ...
            playerSprites.ForEach(sprite =>
            {
                ...
                sprite.ThrusterAnimation.Visable = true;
            });

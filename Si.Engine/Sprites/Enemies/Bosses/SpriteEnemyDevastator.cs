...
using Si.Engine.Sprites.Enemies.Bosses._Superclass;
...
namespace Si.Engine.Sprites.Enemies.Bosses
{
    /// <summary>
    /// 100% Experimental
    /// </summary>
    internal class SpriteEnemyDevastator : SpriteEnemyBossBase
    {
        ...
        public override void LocationChanged()
        {
            if (_leftGun != null && _rightGun != null)
            {
                ...
                {
                    var pointRight = SiPoint.PointFromAngleAtDistance360(Velocity.Angle, new SiPoint(0, 0));
                    _turret.Velocity.Angle.Degrees = AngleTo360(_engine.Player.Sprite);

...
namespace Si.Engine.AI.Logistics
{
    ...
    internal class AILogisticsTaunt : AIStateMachine
    {
            ...
            : base(engine, owner, observedObject)
        {
            ...
            Owner.Travel.DirectionalVelocity = Owner.VelocityInDirection(1.0f);
        ...
        private void AILogistics_OnApplyIntelligence(float epoch, SiPoint displacementVector, AIState state)
        {
            ...
            switch (state)
            {
                ...
                case AIStateEvasiveEscape evasiveEscape:
                    ...
                    {
                        Owner.Travel.AvailableBoost = Owner.RenewableResources.Consume(_boostResourceName, SiRandom.Variance(250, 0.5f));
                    }

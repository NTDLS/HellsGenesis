...
namespace HG.Engine.Types
{
    ...
    internal class HgEngineCallbackEvent
    {
        ...
        public delegate void HgOnExecute(EngineCore core, HgEngineCallbackEvent sender, object refObj);
        ...
        public HgEngineCallbackEvent(EngineCore core, TimeSpan countdown, HgOnExecute executeCallback, object refObj,
        ...
        public HgEngineCallbackEvent(EngineCore core, TimeSpan countdown, HgOnExecute executeCallback)
        {
            _core = core;
            _countdown = countdown;
            _onExecute = executeCallback;

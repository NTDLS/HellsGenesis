...
namespace HG.Utility
{
    internal class HgMath
    {
        ...
        public static double AngleTo(HgPoint from, _SpriteBase to)
        {
            return HgPoint.AngleTo(from, to.Location);
        }

        public static double AngleTo(_SpriteBase from, HgPoint to)
        {
        ...
        public static double DeltaAngle(_SpriteBase fromObj, HgPoint toLocation, double offsetAngle = 0)
        {
        ...
        public static double DeltaAngle360(_SpriteBase fromObj, HgPoint toLocation, double offsetAngle = 0)
        {
            double fromAngle = fromObj.Velocity.Angle.Degrees + offsetAngle;

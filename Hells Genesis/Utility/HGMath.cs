...
namespace HG.Utility
{
    internal class HgMath
    {
        ...
        public static double AngleTo(HgPoint from, SpriteBase to)
        {
            return HgPoint.AngleTo(from, to.Location);
        }

        public static double AngleTo(SpriteBase from, HgPoint to)
        {
        ...
        public static double DeltaAngle(SpriteBase fromObj, HgPoint toLocation, double offsetAngle = 0)
        {
        ...
        public static double DeltaAngle360(SpriteBase fromObj, HgPoint toLocation, double offsetAngle = 0)
        {
            double fromAngle = fromObj.Velocity.Angle.Degrees + offsetAngle;

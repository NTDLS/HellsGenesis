    ...
    public class LogManager
    {
        ...
        public void Write(LogEntry entry)
        {
            try
            {
                ...
                {
                    if (typeof(NsExceptionBase).IsAssignableFrom(entry.Exception.GetType()))
                    {
                        entry.Severity = ((NsExceptionBase)entry.Exception).Severity;
                    }
                }
                ...
                lock (this)
                {
                    ...
                    NsUtility.EnsureNotNull(_fileHandle);
